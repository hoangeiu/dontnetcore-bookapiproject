...
namespace BookApiProject.Services
{
    public class CategoryRepository : ICategoryRepository
    {
        ...
        public bool IsDuplicateCategoryName(int categoryId, string categogyName)
        {
            var category = _categoryContext.Categories.Where(c => c.Name.Trim().ToUpper() == categogyName.Trim().ToUpper()
